    ...
    <div className="min-h-screen px-4 py-16 flex items-center justify-center">
      <div className="w-full max-w-xl border-[8px] border-double border-primary bg-card/95 shadow-[12px_12px_0_hsl(var(--secondary))] p-8 text-center space-y-6">
        <marquee className="bg-secondary text-secondary-foreground py-2 text-xs uppercase tracking-[0.35em]">
          Route not found • The payphone crackles with static • Dial 0 to return
          home •
        </marquee>
        <div className="space-y-4">
          ...
          <p className="font-mono text-sm text-foreground/85">
            We patched you into{" "}
            <span className="font-semibold">{location.pathname}</span>, but the
            line fizzled out. Maybe the cassette got tangled, or maybe that page
            never left the factory.
          </p>
          <p className="text-sm">
            Head back to HQ, drop a quarter, and we&apos;ll get you connected to
            the burger hotline in no time.
          </p>
        </div>
        <Link
          to="/"
        ...
        <p className="text-xs font-mono text-foreground/80">
          Need help? Dial (555) DAVE-NOW from any rotary phone and ask for the
          webmaster.
        </p>
      </div>
    </div>
